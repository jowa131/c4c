...
function loadTopic(topicId) {
    ...
    document.getElementById('visitorCountDisplay').style.display = 'none';
    document.getElementById('feedbackMailbox').style.display = 'none';
...
homeBtn.addEventListener('click', () => {
    ...
    document.getElementById('visitorCountDisplay').style.display = '';
    document.getElementById('feedbackMailbox').style.display = '';
});
